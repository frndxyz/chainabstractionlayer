...
async function expectWagerrFee (chain, txHash, expectedFeePerByte, payToScript) {
  ...
  const maxFeePerByte = BigNumber(BigNumber(expectedFeePerByte).times(size + 2)).div(size) // https://github.com/bitcoin/bitcoin/blob/362f9c60a54e673bb3daa8996f86d4bc7547eb13/test/functional/test_framework/util.py#L40
