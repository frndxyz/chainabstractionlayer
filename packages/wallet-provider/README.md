# `@wagerr-wdk/wallet-provider` <img align="right" src="https://raw.githubusercontent.com/wagerr/chainabstractionlayer/master/liquality-logo.png" height="80px" />
...
[![@wagerr-wdk/wallet-provider](https://img.shields.io/npm/dt/@wagerr-wdk/wallet-provider.svg)](https://npmjs.com/package/@wagerr-wdk/wallet-provider)
...
```bash
npm i @wagerr-wdk/wallet-provider
```

or

```html
<script src="https://cdn.jsdelivr.net/npm/@wagerr-wdk/wallet-provider@0.2.3/dist/wallet-provider.min.js"></script>
<!-- sourceMap at https://cdn.jsdelivr.net/npm/@wagerr-wdk/wallet-provider@0.2.3/dist/wallet-provider.min.js.map -->
