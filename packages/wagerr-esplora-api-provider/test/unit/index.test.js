...
import WagerrEsploraApiProvider from '../../lib'
import Networks from '../../../wagerr-networks/lib'
import mockEsploraApi from '../mock/mockEsploraApi'
chai.use(require('chai-bignumber')())
chai.config.truncateThreshold = 0

describe('Wagerr Esplora Api Provider', () => {
  let client
  let provider
  before(() => {
    mockEsploraApi()
  ...
  beforeEach(() => {
    client = new Client()
    provider = new WagerrEsploraApiProvider('https://blockstream.info/testnet/api', Networks.wagerr_testnet)
  ...
  describe('getTransactionByHash', () => {
    it('should return a transaction', async () => {
      ...
      expect(tx).to.deep.equal({
        ...
        'value': 950018,
        '_raw': {
          'hex': '',
