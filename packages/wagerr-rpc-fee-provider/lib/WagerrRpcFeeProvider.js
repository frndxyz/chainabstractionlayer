...
export default class WagerrRpcFeeProvider extends Provider {
  ...
  async getFee (targetBlocks) {
    ...
    const wait = targetBlocks * 10 * 60 // 10 minute blocks in seconds TODO:wagerr blocktime
...
WagerrRpcFeeProvider.version = version
