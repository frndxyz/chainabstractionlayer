# `@wagerr-wdk/ethereum-networks` <img align="right" src="https://raw.githubusercontent.com/wagerr/chainabstractionlayer/master/liquality-logo.png" height="80px" />
...
[![@wagerr-wdk/ethereum-networks](https://img.shields.io/npm/dt/@wagerr-wdk/ethereum-networks.svg)](https://npmjs.com/package/@wagerr-wdk/ethereum-networks)
...
```bash
npm i @wagerr-wdk/ethereum-networks
```

or

```html
<script src="https://cdn.jsdelivr.net/npm/@wagerr-wdk/ethereum-networks@0.2.3/dist/ethereum-networks.min.js"></script>
<!-- sourceMap at https://cdn.jsdelivr.net/npm/@wagerr-wdk/ethereum-networks@0.2.3/dist/ethereum-networks.min.js.map -->
