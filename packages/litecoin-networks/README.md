# `@wagerr-wdk/bitcoin-networks` <img align="right" src="https://raw.githubusercontent.com/wagerr/chainabstractionlayer/master/liquality-logo.png" height="80px" />
...
[![@wagerr-wdk/bitcoin-networks](https://img.shields.io/npm/dt/@wagerr-wdk/bitcoin-networks.svg)](https://npmjs.com/package/@wagerr-wdk/bitcoin-networks)
...
```bash
npm i @wagerr-wdk/bitcoin-networks
```

or

```html
<script src="https://cdn.jsdelivr.net/npm/@wagerr-wdk/bitcoin-networks@0.2.3/dist/bitcoin-networks.min.js"></script>
<!-- sourceMap at https://cdn.jsdelivr.net/npm/@wagerr-wdk/bitcoin-networks@0.2.3/dist/bitcoin-networks.min.js.map -->
