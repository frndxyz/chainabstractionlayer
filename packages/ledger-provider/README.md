# `@wagerr-wdk/ledger-provider` <img align="right" src="https://raw.githubusercontent.com/wagerr/chainabstractionlayer/master/liquality-logo.png" height="80px" />
...
[![@wagerr-wdk/ledger-provider](https://img.shields.io/npm/dt/@wagerr-wdk/ledger-provider.svg)](https://npmjs.com/package/@wagerr-wdk/ledger-provider)
...
```bash
npm i @wagerr-wdk/ledger-provider
```

or

```html
<script src="https://cdn.jsdelivr.net/npm/@wagerr-wdk/ledger-provider@0.2.3/dist/ledger-provider.min.js"></script>
<!-- sourceMap at https://cdn.jsdelivr.net/npm/@wagerr-wdk/ledger-provider@0.2.3/dist/ledger-provider.min.js.map -->
