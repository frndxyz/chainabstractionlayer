...
import * as WagerrUtil from '../../lib'

describe('Wagerr Util', () => {
  describe('calculateFee', () => {
    it('should return correct fees', () => {
      expect(WagerrUtil.calculateFee(1, 1, 3)).to.equal(576)
      expect(WagerrUtil.calculateFee(2, 1, 3)).to.equal(1020)
    })
  })

  describe('compressPubKey', () => {
    it('should return compressed public key', () => {
      expect(WagerrUtil.compressPubKey('0493fc49dfd662510bc4d91b4f689d1732ebe4e2d7a67eebc37f76c8d6ec283ef098574ba8b41581532c09f38e47d1790dad1a09417ddbde95af5a1314f3f08c37')).to.equal('0393fc49dfd662510bc4d91b4f689d1732ebe4e2d7a67eebc37f76c8d6ec283ef0')

      expect(WagerrUtil.compressPubKey('04b1c13be24ddc9f6e816d5469f0874ed965c8bef4084b465f679bf05071b676b888e708bc3648c4fab3468d2f527eb0e3da99025b0962985b2563ec191c1fd158')).to.equal('02b1c13be24ddc9f6e816d5469f0874ed965c8bef4084b465f679bf05071b676b8')
    })
  })

  describe('txHashToObject', () => {
    it('p2pkh', () => {
      const hash = ''
      const object = WagerrUtil.decodeRawTransaction(hash, WagerrNetworks.wagerr_testnet)
        ...
        'vout': [
          {
            ...
            'scriptPubKey': {
              ...
              'addresses': [
                'tb1qqwzywrzugq5x03hyqyvjx8n6wv4v8dx497ptcc'
              ]
            }
          },
          {
            ...
            'scriptPubKey': {
              ...
              'type': 'witness_v0_keyhash',
              'addresses': [
                'tb1qdgjp30mvy7faut5m68yaveud4znmqsxqcdtpap'
              ]
            }
          }
        ],
        'hex': ''
      })
    })

    it('p2wsh (swap)', () => {
      const hash = ''
      const object = WagerrUtil.decodeRawTransaction(hash, WagerrNetworks.wagerr)
      expect(object).to.deep.equal({
        ...
        'vout': [
          {
            ...
            'scriptPubKey': {
              ...
              'addresses': [
                'bc1qvzjae8595pq77nlnzfhsht9x48mcjs8dd5elf93x9xn7udxsh8zsjva57z'
              ]
            }
          },
          {
            ...
            'scriptPubKey': {
              ...
              'type': 'witness_v0_keyhash',
              'addresses': [
                'bc1qe5zluh9z943pxmfx8harezkuweyktu09cxxkac'
              ]
            }
          }
        ],
    ...
    it('p2wsh (swap redeem)', () => {
      const hash = ''
      const object = WagerrUtil.decodeRawTransaction(hash, WagerrNetworks.wagerr)
      expect(object).to.deep.equal({
        ...
        'vout': [
          {
            ...
            'scriptPubKey': {
              ...
              'type': 'witness_v0_keyhash',
              'addresses': [
                'bc1qcskm59tkmxaxr8vjk3lzd7tls7g2vkuyujtvl3'
              ]
            }
          }
        ],
