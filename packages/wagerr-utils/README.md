# `@wagerr-wdk/wagerr-utils` <img align="right" src="https://raw.githubusercontent.com/wagerr/chainabstractionlayer/master/liquality-logo.png" height="80px" />
...
[![@wagerr-wdk/wagerr-utils](https://img.shields.io/npm/dt/@wagerr-wdk/wagerr-utils.svg)](https://npmjs.com/package/@wagerr-wdk/wagerr-utils)
...
```bash
npm i @wagerr-wdk/wagerr-utils
```

or

```html
<script src="https://cdn.jsdelivr.net/npm/@wagerr-wdk/wagerr-utils@0.2.3/dist/wagerr-utils.min.js"></script>
<!-- sourceMap at https://cdn.jsdelivr.net/npm/@wagerr-wdk/wagerr-utils@0.2.3/dist/wagerr-utils.min.js.map -->
<!-- available as window.WagerrUtils -->
```
