# `@wagerr-wdk/bundle` <img align="right" src="https://raw.githubusercontent.com/wagerr/chainabstractionlayer/master/liquality-logo.png" height="80px" />
...
[![@wagerr-wdk/bundle](https://img.shields.io/npm/dt/@wagerr-wdk/bundle.svg)](https://npmjs.com/package/@wagerr-wdk/bundle)
...
```bash
npm i @wagerr-wdk/bundle
```

or

```html
<script src="https://cdn.jsdelivr.net/npm/@wagerr-wdk/bundle@0.2.3/dist/bundle.min.js"></script>
<!-- sourceMap at https://cdn.jsdelivr.net/npm/@wagerr-wdk/bundle@0.2.3/dist/bundle.min.js.map -->
